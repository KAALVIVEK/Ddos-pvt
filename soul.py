...
TELEGRAM_BOT_TOKEN = '8089725327:AAELTKtjIuTLaiSBcaZpvQNdcGEAlJMjqxk'
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥chudai chalu h feedback bhej dena @TREXVIVEK💥*"
    ),
    parse_mode='Markdown'
)
